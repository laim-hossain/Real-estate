            ...
            if (h = (d = a[r]).parentNode === D,
                ...
                if (G && (A = d.style,
                    ...
                    if (d._isSplit)
                        ...
                        d.parentNode._isSplit ? (d._parent = d.parentNode, !d.previousSibling && d.firstChild && (d.firstChild._isFirst = !0),
        ...
        for (v.insertBefore(y, D),
            ...
            l = -1 !== (F = function getText(D) {
                ...
                if (1 === u || 9 === u || 11 === u) {
                    ...
                    return D.nodeValue;
                return e
            }(D = y)).indexOf("<"), !1 !== u.reduceWhiteSpace && (F = F.replace(S, " ").replace(b, "")),
            l && (F = F.split("<").join("{{LT}}")),
            E = F.length,
            C = (" " === F.charAt(0) ? A : "") + e(),
            i = 0; i < E; i++)
